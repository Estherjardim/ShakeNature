...
<link rel="stylesheet" href="/lojamilkshake/public/assets/src/style.css">
...
• <a href="/shakenature/index.php?controller=auth&action=logout">Sair</a>
</div>
</div>
...
<a class="btn" href="/lojamilkshake/index.php?controller=auth&action=dashboard">Voltar ao
Dashboard</a>
</div>
</div>
</div>
